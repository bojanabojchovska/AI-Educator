...
const FlashcardGamePage = () => {
  ...
  const handleFileChange = (event) => {
    ...
    setIsGenerated(false); // Reset if new file is uploaded
  };
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      setIsGenerated(true); // Set to true when flashcards are successfully generated
  ...
  const handleDownload = () => {
    window.open('http://localhost:8080/api/flashcards/export/1', '_blank'); // Hardcoded course ID
  };
